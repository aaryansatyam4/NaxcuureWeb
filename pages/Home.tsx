                ...
                <div className="grid md:grid-cols-2 gap-16 items-center max-w-7xl mx-auto">
                    <AnimatedSection>
                        <div className="w-full h-[500px] rounded-lg overflow-hidden shadow-2xl">
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d885.3567747385462!2d72.4614479149002!3d23.320080999785503!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395c25a04ef22995%3A0x2c486bf920f7be43!2sNaxcuure%20Healthcare%20Pvt.%20Ltd.!5e0!3m2!1sen!2sin!4v1762334985724!5m2!1sen!2sin"
                                width="100%"
                                height="100%"
                                style={{ border: 0 }}
                                allowFullScreen=""
...
const Home = () => {
    ...
    return (
        <div className="bg-light-bg text-gray-800">
            ...
            {/* Content Sections (img1 right, img2 left, img3 right) */}
            <div className="py-24 md:py-32 bg-light-bg">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 space-y-24 md:space-y-32">
                    ...
                    <AnimatedSection>
                        <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
                            ...
                            <div className="w-full h-80 md:h-96 rounded-lg overflow-hidden shadow-2xl">
                                <img src="/img1.jpg" alt="Section Visual 1" className="w-full h-full object-cover" />
                            </div>
                        </div>
                    </AnimatedSection>
                    ...
                    <AnimatedSection>
                        <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
                            <div className="order-1 md:order-1 w-full h-80 md:h-96 rounded-lg overflow-hidden shadow-2xl">
                                <img src="/img2.jpg" alt="Section Visual 2" className="w-full h-full object-cover" />
                            </div>
                    ...
                    <AnimatedSection>
                        <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
                            <div className="order-2 md:order-2 w-full h-80 md:h-96 rounded-lg overflow-hidden shadow-2xl">
                                <img src="/img3.jpg" alt="Section Visual 3" className="w-full h-full object-cover" />
                            </div>
