        ...
        <div className="bg-light-bg">
            ...
            <div className="py-24 md:py-32">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <AnimatedSection>
                        <div className="mb-12 bg-white p-4 rounded-lg shadow-md border border-gray-200/60">
                            <input
                                type="text"
                                ...
                                {paginatedProducts.map((product, index) => (
                                    <AnimatedSection key={product.id} delay={`${index * 50}ms`}>
                                        ...
                                        >
                                            ...
                                            <p className="font-sans text-sm text-accent bg-accent/10 px-2 py-1 rounded-full self-start">
